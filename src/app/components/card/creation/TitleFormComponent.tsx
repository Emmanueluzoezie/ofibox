...
const TitleFormComponent = () => {
  ...
  return (
    <div className=" w-8/12 mx-auto mt-4">
      <input type="text" placeholder="Card Title" className=" text-zinc-200 bg-zinc-900 w-full h-10 px-3 rounded border-0 outline-none" maxLength={14} onChange={handleChange} />
    </div>
  )
}
