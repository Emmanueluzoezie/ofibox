...
const VideoItem = ({ tournament }: Props) => {
    ...
    return (
        <div className='relative secondary-text-color mx-auto md:w-[600px] lg:w-[800px] '>
            <h2 className='text-center py-[60px] md:py-[20] lg:pb-0 text-[20px] px-4 font-mono'>Create card games and tournament for your communities events in minutes.</h2>
